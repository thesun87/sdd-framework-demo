...
created: 2026-09-18
updated: 2026-09-19
curated_from: 'planning-artifacts/briefs/brief-sdd-framework-demo-2026-09-18/brief.md'
...
> **Đây là bản baseline.** Bản thô và `addendum.md` (bảng NFR gốc, lý do loại
> cổng thanh toán, tám câu hỏi mở ban đầu) nằm ở
> `planning-artifacts/briefs/brief-sdd-framework-demo-2026-09-18/`.
...
- **Personal data.** Customer name, phone, and delivery address fall under Luật Bảo vệ dữ liệu cá nhân 91/2025/QH15. Collect only what fulfilment requires.
