...
status: final
sources:
  - docs/baseline/planning-artifacts/prds/prd-sdd-framework-demo-2026-09-18/prd.md
  - docs/baseline/planning-artifacts/prds/prd-sdd-framework-demo-2026-09-18/addendum.md
  - imports/ref-ui-danh-muc-san-pham.png
updated: 2026-09-18
---
...
**Mock tham chiếu:** [Trang chủ](mockups/trang-chu.html) ·
[Đơn chưa đặt được](mockups/don-chua-dat-duoc.html) ·
...
3. **Tối thiểu hoá dữ liệu.** Không sổ địa chỉ, không hồ sơ cá nhân, không theo dõi hành vi,
   không analytics bên thứ ba (PRD §9.2, NĐ 13/2023/NĐ-CP). Địa chỉ giao hàng được nhập lại
...
Xem thật: [Trang chủ](mockups/trang-chu.html) (sidebar có số đếm, thẻ sản phẩm, nhãn tồn kho) ·
[Trang quản trị — Danh sách đơn hàng](mockups/quan-tri-danh-sach-don.html) (bảng đơn hàng, bộ lọc
...
Xem thật: trạng thái **Hết hàng** trong [Trang chủ](mockups/trang-chu.html) ·
**Đơn hàng không huỷ được** trong [Chi tiết đơn hàng của tôi](mockups/chi-tiet-don-cua-toi.html)
...
- **Bác bỏ — Sổ địa chỉ của Khách hàng** (ADD §4). Địa chỉ giao hàng nhập lại trên từng đơn
  hàng, điền sẵn từ đơn hàng gần nhất. Đây là quyết định tối thiểu hoá dữ liệu theo NĐ 13/2023,
...
NĐ 13/2023 + tối thiểu hoá dữ liệu đặt câu hỏi về việc thu thập một trường không dùng đến.
